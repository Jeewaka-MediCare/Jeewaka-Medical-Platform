...
export const medicalRecordsService = {
  ...
  getPatientRecords: async (patientId) => {
    try {
      ...
      throw new Error(
        handleApiError(error, "Failed to load medical records").message
      );
    }
  },
  ...
  createRecord: async (patientId, recordData) => {
    try {
      ...
      throw new Error(
        handleApiError(error, "Failed to create medical record").message
      );
    }
  },
  ...
  updateRecord: async (recordId, updateData) => {
    try {
      ...
      throw new Error(
        handleApiError(error, "Failed to update medical record").message
      );
    }
  },
  ...
  getRecord: async (recordId) => {
    try {
      ...
      throw new Error(
        handleApiError(error, "Failed to load medical record").message
      );
    }
  },
  ...
  deleteRecord: async (recordId) => {
    try {
      ...
      throw new Error(
        handleApiError(error, "Failed to delete medical record").message
      );
    }
  },
  ...
  createVersion: async (recordId, versionData) => {
    try {
      ...
      throw new Error(
        handleApiError(error, "Failed to create record version").message
      );
    }
  },
  ...
  getRecordVersions: async (recordId) => {
    try {
      ...
      throw new Error(
        handleApiError(error, "Failed to load record versions").message
      );
    }
  },
  ...
  getAuditTrail: async (patientId, filters = {}) => {
    try {
      ...
      const url = `/api/medical-records/patients/${patientId}/audit${
        params ? `?${params}` : ""
      }`;
      ...
      throw new Error(
        handleApiError(error, "Failed to load audit trail").message
      );
    }
  },
};

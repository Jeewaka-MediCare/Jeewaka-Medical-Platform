        ...
        <Card className="p-0 shadow-md border border-gray-200 bg-white">
          <CardContent className="flex items-center gap-6 py-6 px-8">
            <Avatar className="w-24 h-24 border-4 border-green-200 shadow-lg">
              ...
              />
              <AvatarFallback className="bg-gradient-to-r from-green-600 to-green-700 text-white text-3xl font-bold">
                {(doctorData?.name || user?.name)?.charAt(0)?.toUpperCase()}
              </AvatarFallback>
            </Avatar>
            <div className="flex flex-col justify-center">
              <h1 className="text-3xl font-bold text-gray-900 mb-1"> {doctorData?.name || user?.name}</h1>
              <p className="text-lg text-gray-600 font-medium mb-1">{doctorData?.specialization}</p>
              <p className="text-base text-gray-500">Welcome back to your dashboard</p>
            </div>
          </CardContent>
        </Card>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold"> {doctorData?.name || user?.name}</h3>
